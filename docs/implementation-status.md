...
| Output — realny dźwięk systemowy (PipeWire/Pulse) | — | 100% — `linrdp/src/sound_real.rs` (monitor `linrdp_sink`, fragsize=40 ms — niska latencja, cap backlog ~1 s, realne timestampy Wave) | 80% — dźwięk słyszalny u klienta; latencja do ponownego potwierdzenia po zmianach | ✅ działa |
